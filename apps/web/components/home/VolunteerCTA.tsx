      ...
      <div className="relative overflow-hidden rounded-[2.5rem] gradient-plum text-primary-foreground p-10 md:p-16 lg:p-20 shadow-lift">
        ...
        <div className="relative grid lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="w-full max-w-sm aspect-square rounded-3xl bg-primary-foreground/5 border border-primary-foreground/10 flex items-center justify-center">
              <Heart className="w-24 h-24 text-accent/60" />
            </div>
          </div>
        </div>
      </div>
