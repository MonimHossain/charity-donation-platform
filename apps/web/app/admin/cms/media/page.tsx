                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="aspect-square bg-muted/50 flex items-center justify-center overflow-hidden">
                          {isImage ? (
                            <img src={resolveMediaUrl(file.url) ?? file.url} alt={file.name || imageAltFromSrc(file.url)} className="w-full h-full object-cover" loading="lazy" />
                          ) : (
                            ...
                            <td className="px-3 py-2">
                              <div className="flex items-center gap-2">
                                {file.type.startsWith("image/") ? (
                                  <img src={resolveMediaUrl(file.url) ?? file.url} alt={imageAltFromSrc(file.url) || file.name} className="h-8 w-8 rounded object-cover" />
                                ) : (
            ...
            <div className="w-72 shrink-0 rounded-2xl border bg-card shadow-soft p-4 space-y-4 self-start sticky top-4">
              ...
              <div className="aspect-square rounded-lg bg-muted/50 overflow-hidden flex items-center justify-center">
                {selectedFile.type.startsWith("image/") ? (
                  <img src={resolveMediaUrl(selectedFile.url) ?? selectedFile.url} alt={selectedFile.name || imageAltFromSrc(selectedFile.url)} className="w-full h-full object-contain" />
